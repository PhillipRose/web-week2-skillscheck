...
const me = {
    firstName: 'Phillip',
    superHeroName: 'Radar Ears',
    homeTown: 'Park City',
    superPowers:['Super Hearing', 'Magnanimous Recollection', 'Frost Tolerance'] ,
...
let setColor = loop = arr =>{
    arr.splice(3);
    for (let i =0; i < arr.length; i++){
        if (arr[i]==='blue'){
            // let arr[i] = '#4D4DFF' Throwing an error not sure why
